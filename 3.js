...
function toserba (barang, uang) {
  ...
  if(barang === 'pensil'){
      ...
      if(uang >= 10000){
        message = `Berhasil membeli ${barang}, kembalianya Rp.${uang - 10000}`
      }else{
        message = `Uang tidak cukup untuk membeli ${barang}`
      }

  }else if(barang === 'penghapus'){

    if(uang >= 15000){
      message = `Berhasil membeli ${barang}, kembalianya Rp.${uang - 15000}`
    }else{
      message = `Uang tidak cukup untuk membeli ${barang}`
    }
    ...
    if(uang >= 7500){
      message = `Berhasil membeli ${barang}, kembalianya Rp.${uang - 7500}`
    }else{
      message = `Uang tidak cukup untuk membeli ${barang}`
    }
    ...
    if(uang >= 7000){
      message = `Berhasil membeli ${barang}, kembalianya Rp.${uang - 7000}`
    }else{
      message = `Uang tidak cukup untuk membeli ${barang}`
    }
